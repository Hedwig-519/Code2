...
<%} %>
  <div class="form-row">
    ...
    <div class="form-group col-12">
      <label>Giá</label>
      <input type="number" min = "0" class="form-control" name = "txtGia" value = "<%=giay != null ? giay.getGia() : ""%>">
    </div>
    <br>
  </div>
  <div class="form-group col-12">
    <label>Số lượng</label>
    <input type="number" min = "1" class="form-control"  name = "txtSoLuong" value = "<%=giay != null ? giay.getSoLuongTon() : ""%>">
  </div>
  <br>
      <div class="form-group col-12">
      <label>Màu sắc</label>
