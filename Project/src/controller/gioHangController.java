...
public class gioHangController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (maGiay != null) {
				/*
				 * Giaybo gibo = new Giaybo(); Giaybean gibean =
				 * gibo.getMatHang(Long.parseLong(maGiay)); if (Integer.parseInt(soLuong) <
				 * gibean.getSoLuongTon()) { request.setAttribute("vuotHan",
				 * "Số lượng bạn chọn vượt quá số lượng tồn"); response.sendRedirect(soLuong); }
				 */
